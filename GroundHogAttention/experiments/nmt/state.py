...
def prototype_encdec_state():
    ...
    state = prototype_state()
	# target english source chinese
    state['target'] = ["data/poem/DataA1Symbol/text.t.shuf.h5"]
    state['source'] = ["data/poem/DataA1Symbol/text.s.shuf.h5"]
    state['indx_word'] = "data/poem/DataA1Symbol/ivocab.s.pkl"
    state['indx_word_target'] = "data/poem/DataA1Symbol/ivocab.t.pkl"
    state['word_indx'] = "data/poem/DataA1Symbol/vocab.s.pkl"
    state['word_indx_trgt'] = "data/poem/DataA1Symbol/vocab.t.pkl"

    state['null_sym_source'] = 8652
    state['null_sym_target'] = 8535
    state['n_sym_source'] = state['null_sym_source'] + 1
    state['n_sym_target'] = state['null_sym_target'] + 1
